...
<link href="<?php echo Yii::app()->baseUrl; ?>/js/libs/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
<!--<link href="--><?php //echo Yii::app()->baseUrl; ?><!--/js/libs/datatables/css/dataTables.bootstrap.min.css" rel="stylesheet">-->
<script src="<?php echo Yii::app()->baseUrl; ?>/js/libs/datatables/js/jquery.dataTables.min.js"></script>
<!--<script src="--><?php //echo Yii::app()->baseUrl; ?><!--/js/libs/datatables/js/dataTables.bootstrap.min.js"></script>-->
<script type="text/javascript">
    var arr_json = '<?php echo $arr_json;?>';
    jQuery(document).ready(function ($){
        $('.grid-view .items').addClass('table table-striped table-bordered').DataTable({
            "pageLength": 25
        });
    }    );
</script>
...
<style>
    @font-face {
        ...
        src: url('<?php echo Yii::app()->baseUrl; ?>/js/libs/fonts/glyphicons-halflings-regular.eot');
        src: url('<?php echo Yii::app()->baseUrl; ?>/js/libs/fonts/.eot?#iefix') format('embedded-opentype'),
        url('<?php echo Yii::app()->baseUrl; ?>/js/libs/fonts/glyphicons-halflings-regular.woff2') format('woff2'),
        url('<?php echo Yii::app()->baseUrl; ?>/js/libs/fonts/glyphicons-halflings-regular.woff') format('woff'),
        url('<?php echo Yii::app()->baseUrl; ?>/js/libs/fonts/glyphicons-halflings-regular.ttf') format('truetype'),
        url('<?php echo Yii::app()->baseUrl; ?>/js/libs/fonts/glyphicons-halflings-regular.svg#@{icon-font-svg-id}') format('svg');
    }
</style>
<div></div>
