...
$this->widget('bootstrap.widgets.TbBreadcrumbs', array(
    'links'=>array('Events','Summary of activity by facility')));

$form = $this->beginWidget(
    'bootstrap.widgets.TbActiveForm', array(
        'id' => 'inlineEventsFacilityForm',
      ...
      <i data-time-icon="icon-time" data-date-icon="icon-calendar">
        ...
        <span style ="margin :10px">
            ...
            $this->widget(
                ...
                array('buttonType' => 'submit', 'label' => 'Search','type'=>'primary','htmlOptions'=>array('id'=>'facilitysubmit','style'=>'vertical-align: top;'))
            );
            echo '</span><span>';
            $this->widget(
...
$this->widget('bootstrap.widgets.TbGridView', array(
    ...
    'columns'         => array(
        ...
        array(
            ...
            'buttons'=>array(
                'view' => array(
                    'url'=>'Yii::app()->controller->createUrl("events/facilitydet", array("facility"=>$data["facility"]))',
                ),
            ),
