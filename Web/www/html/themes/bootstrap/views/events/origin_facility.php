...
$this->widget('bootstrap.widgets.TbBreadcrumbs', array(
    'links'=>array('Events','Summary of activity by facility'=>'index.php?r=events/summarybyfacility', 'Facility details by origin'),
));
      ...
      <i data-time-icon="icon-time" data-date-icon="icon-calendar">
        ...
        <span style ="margin :10px">
            ...
            $this->widget(
                ...
                array('buttonType' => 'submit', 'label' => 'Search','type'=>'primary','htmlOptions'=>array('id'=>'facorsubmit','style'=>'vertical-align: top;'))
            );
            echo '</span><span>';
            $this->widget(
