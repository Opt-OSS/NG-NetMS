...
class DbSettings
{
    public:
        ...
        {
            return other.m_Host 		== m_Host &&
                   other.m_Port			== m_Port &&
                   other.m_DbName		== m_DbName &&
                   other.m_DbUser		== m_DbUser &&
                   other.m_DbPassword	        == m_DbPassword &&
	...
	bool FillFromFile( string FileName )
	{
	    ...
	    if( !configReader.GetParameter( "Host", 		tmpDbSettings.m_Host ) ||
		!configReader.GetParameter( "Port", 		tmpDbSettings.m_Port ) ||
