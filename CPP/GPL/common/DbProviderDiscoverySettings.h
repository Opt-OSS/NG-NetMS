...
class DbProviderDiscoverySettings
{
    private:
    ...
    public:
        DbProviderDiscoverySettings( Type& DbProvider ):
        ...
        {
            vector<string> names{ GEN_SETTINGS_SEEDHOST,
            ...
            Settings = DiscoverySettings( values[GEN_SETTINGS_SEEDHOST],
