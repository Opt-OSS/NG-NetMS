...
public:
	void Execute(int argc, char* argv[])
	{
		...
		try
		{
			...
			desc.add_options()("help", "produce help message")("seed-host,h", value<string>(&m_SeedHosts), "Seed Host")(
			...
			)("host-type,t", value<string>(&m_HostType), "Juniper/Cisco")("access,a", value<string>(&m_Access), "SSH/Telnet")
