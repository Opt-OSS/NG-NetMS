...
SyslogFileDP::SyslogFileDP(string FileName): m_FileName(FileName), m_Interrupted(false)
{
}

SyslogFileDP::~SyslogFileDP()
{
}

bool SyslogFileDP::Run()
{
	fstream fileStream;
	try
	{
...
bool SyslogFileDP::Stop()
{
	m_Interrupted = true;
	return true;
}

void SyslogFileDP::RegisterListener(DataProviderListener &Listener)
{
	m_Notifier.Register(Listener);
}

void SyslogFileDP::UnregisterListener(DataProviderListener &Listener)
{
