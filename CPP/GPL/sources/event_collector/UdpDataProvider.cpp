...
UdpDataProvider::UdpDataProvider( int Port ):
m_Port( Port ),
m_Interrupted( false )
{
...
UdpDataProvider::~UdpDataProvider( )
{

}

void UdpDataProvider::ReportMessage(  string& IpAddress,  string& Message )
{
...
void UdpDataProvider::RegisterListener( DataProviderListener &Listener )
{
    m_Notifier.Register( Listener );
}

void UdpDataProvider::UnregisterListener( DataProviderListener &Listener )
{
