...
Options::Options():
	m_SourceType(SourceType::SNMP_FILE_POLLING), m_FileName("/var/log/syslog"), m_LogFileName("ngnms_collector.log"),
	m_RuleFileName("rules.txt"), m_DbSettingsFileName("db.cfg"), m_Port(514), m_BindIPAddress("0.0.0.0"), m_OriginalTs(false),
	m_Debug(false), m_RenewTables(false)
{
}
