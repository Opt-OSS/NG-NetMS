...
echo AppRun.pl  --mode=poll-host -D ngnms -U ngnms -W optoss --host=$origin
logger "LOG: --> App.pl  --mode=poll-host -D ngnms -U ngnms -W optoss --host=$origin ..."

AppRun.pl  --mode=poll-host -D ngnms -U ngnms -W optoss --host=$origin
