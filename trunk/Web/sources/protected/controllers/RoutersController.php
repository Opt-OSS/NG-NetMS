            ...
            if (Yii::app()->user->checkAccess('editAssets')) {
                ...
                if (Yii::app()->request->isAjaxRequest) {
                    if (isset( $_POST['tumbler'] ) && $_POST['tumbler'] > 0) {
                        ...
                        putenv('NGNMS_LOGFILE=/home/ngnms/NGREADY/logs/all_php.log');
                        putenv('PATH=/home/ngnms/NGREADY/bin:/usr/bin');
                        putenv('PERL5LIB=/home/ngnms/NGREADY/bin:/home/ngnms/NGREADY/lib:/home/ngnms/NGREADY/lib/Net:/usr/local/share/perl/5.18.2');
