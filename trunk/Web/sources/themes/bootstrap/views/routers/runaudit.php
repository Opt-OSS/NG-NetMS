...
if (1) { ?>
    ...
    $this->beginWidget('bootstrap.widgets.TbModal',
        array('id' => 'periodset', 'htmlOptions' => array('style' => 'width: 400px;max-height:500px'))); ?>
    ...
    $this->widget(
        'bootstrap.widgets.TbButton', array(
            'id'          => 'selPeriod',
            'buttonType'  => 'ajaxSubmit',
            'label'       => "Schedule  periodic discovery (current: every $cur_disc)",
            'type'        => 'info',
            'htmlOptions' => array(
                'style'   => "margin-left:35px;",
                'onclick' => "js:var scan_t = $('#scanner').val(); viewForm(scan_t);return false;"
            ),
        )
    );
    ?>
